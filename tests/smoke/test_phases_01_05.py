"""Smoke test: Phases 01-05 live REGDOCS single-filing run.

Extends the 01-04 smoke test with Phase 05 (LLM analysis via Claude CLI).
Validates that foundation, scraping, downloading, extraction, and analysis
work together against the live REGDOCS site with strict safety constraints:
...
See .planning/SMOKE_TEST_01_05_LIVE.md for full runbook.
"""
...
# ---------------------------------------------------------------------------
# Evidence capture (extended for Phase 5)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Verification and evidence (extended for Phase 5)
# ---------------------------------------------------------------------------
...
def run_smoke_test() -> SmokeEvidence:
    """Execute the full smoke test (Phases 01-05) and return evidence."""
    ...
    # Pre-run checks
    print("=" * 60)
    print("SMOKE TEST: Phases 01-05 (Live REGDOCS, Single Filing)")
    print("=" * 60)
    print()
    ...
    try:
        ...
        with session_factory() as session:
            ...
            # Verification
            print("[Verify] Checking final state (Phases 1-5)...")
